...
@section('content')
  <div class="container col s12 m6" style="height:100px">
    <h4>Staff Profile</h4>
    <br>
    <div class="card-panel blue lighten-4 col s9" style="height:auto; margin:2px; border-radius:10px;">
       ...
       <p class="flow-text"><b><a href="/staffs/{{$profiles->profile_id}}/edit" class="btn btn-small green darken-2  z-depth-2">Edit</a></p></b>
